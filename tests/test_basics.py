...
# Add more tests to validate the behavior of the speckle pattern, the correctness of different shapes, etc.
# These will require a deeper understanding of the expected behavior and possibly some visual inspection or
# statistical properties checks.

# Some edge cases or invalid arguments checks:
...
# Note: Additional tests should be added based on the behavior of your functions.
